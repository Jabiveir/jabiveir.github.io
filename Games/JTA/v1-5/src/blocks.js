export default class Blocks {
	...
	DrawBlock(Ctx, Player) {
		if (this.BData.Type === "Block") {
			Ctx.fillStyle = "#000";
			Ctx.fillRect(this.BData.XPos * 24, this.BData.YPos * 24, 24, 24);
		}
		if (this.BData.Type === "Platform") {
			Ctx.fillStyle = "#000";
			Ctx.fillRect(this.BData.XPos * 24, this.BData.YPos * 24, 24, 3);
		}
		...
		if (this.BData.Type === "Purple") {
			if (Player.PData.Timer % 8 < 4) {
				Ctx.fillStyle = "#f0f";
				Ctx.fillRect(this.BData.XPos * 24, this.BData.YPos * 24, 24, 24);
				Ctx.fillStyle = "#c0c";
				Ctx.fillRect(
		...
		if (
			...
			if (
				...
				if (
					...
					(Block.BData.Type === "Purple" && Player.PData.Timer % 8 < 4)
				) {
					Player.PData.YVel = 0;
					Player.PData.YPos = Block.BData.YPos * 24 - 20;
					Block.BData.Temp = true;
